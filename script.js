// ===============================
// FUFATHON – LIVE přes Worker /state + GOALY
// ===============================
  ...
  for (const g of GOALS) {
    ...
    li.innerHTML = `
      <div class="goal-left">
        ...
        <div class="goal-meta">
          <span class="goal-status">${reached ? "✅ splněno" : (isNext ? "✨ nejbližší" : "⏳ čeká")}</span>
        </div>
      </div>
...
function renderState(state) {
  ...
  // volitelné texty, pokud existují v HTML
